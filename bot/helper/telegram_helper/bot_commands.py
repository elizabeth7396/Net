...
class _BotCommands:
    def __init__(self):
        ...
        self.QbMirrorCommand = getCommand('QBMIRROR_CMD', f'adaf{CMD_INDEX}')
        self.QbUnzipMirrorCommand = getCommand('QBUNZIP_CMD', f'fsfs{CMD_INDEX}')
        self.QbZipMirrorCommand = getCommand('QBZIP_CMD', f'ghdg{CMD_INDEX}')
        ...
        self.QbLeechCommand = getCommand('QBLEECH_CMD', f'qhshs{CMD_INDEX}')
        self.QbUnzipLeechCommand = getCommand('QBZIPLEECH_CMD', f'fafaf{CMD_INDEX}')
        self.QbZipLeechCommand = getCommand('QBUNZIPLEECH_CMD', f'uutut{CMD_INDEX}')
